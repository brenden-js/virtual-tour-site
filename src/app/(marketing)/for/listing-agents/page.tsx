import ListingAgentHero from "@/components/landing-pages/listing-agents/hero";
import ListingStats from "@/components/landing-pages/listing-agents/stats";
...
export default function ListingAgents() {
  const posts = allPosts
    .filter((post) => post.avatar === "listing-agents")
    .sort((a, b) => {
    ...
    >
      ...
      <div className="py-32">
        <div className="mx-auto my-6  flex max-w-[58rem] flex-col items-center space-y-4 text-center">
          ...
          Upgrade your listing package.
          </h2>
          <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
            Here&apos;s our latest posts for listing agents.
          </p>
        </div>
