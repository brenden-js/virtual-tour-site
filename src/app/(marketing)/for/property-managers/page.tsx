import PropertyManagerHero from "@/components/landing-pages/property-managers/hero";
import ManagerStats from "@/components/landing-pages/property-managers/stats";
...
export default function ListingAgents() {
  const posts = allPosts
    .filter((post) => post.avatar === "property-managers")
    .sort((a, b) => {
    ...
    >
      ...
      <div className="py-32">
        <div className="mx-auto my-6  flex max-w-[58rem] flex-col items-center space-y-4 text-center">
          ...
          Grow your profits with 3D tours.
          </h2>
          <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
            Here&apos;s our latest posts for property managers.
          </p>
        </div>
